...
interface HomeProps {
    rooms: DBRoom[]; // Renamed prop to match standard
}
...
export default function Home({ rooms }: HomeProps) {
    ...
    // Handler para abrir o formulário de qualificação
    ...
    // Handler para reservar do modal de detalhes
    const handleReservarFromDetails = (roomData: any) => {
        setSelectedRoom(null); // Fecha detalhes
        handleOpenBooking(roomData.name); // Abre lead form
    };
    ...
    return (
        <>
            ...
            <Layout headerVariant="fixed" className="overflow-x-hidden">
                ...
                <section data-cards-section className="py-20 bg-warm-50 scroll-mt-20">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="text-center mb-16">
                            <span className="inline-block bg-accent-100 text-accent-700 px-4 py-1.5 rounded-full text-sm font-semibold mb-4">
                                Nossos Consultórios
            ...
            {selectedRoom && (
                <RoomDetailsModal
                    ...
                    onReservar={handleReservarFromDetails}
                    room={selectedRoom}
                />
            )}
